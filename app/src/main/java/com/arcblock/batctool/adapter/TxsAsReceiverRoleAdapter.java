...
public class TxsAsReceiverRoleAdapter extends BaseQuickAdapter<TransactionsByAddressQuery.Datum, BaseViewHolder> {
    public TxsAsReceiverRoleAdapter(int layoutResId, @Nullable List<TransactionsByAddressQuery.Datum> data) {
